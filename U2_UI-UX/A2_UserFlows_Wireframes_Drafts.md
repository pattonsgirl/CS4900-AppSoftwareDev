### **Assignment 2 – Userflows and Wireframes in Figma**
...
* Use basic shapes, labels, and layout either pulled from the library and/or created from the tools within Figma. No color or styling will be added yet.  
* **Add short notes / explanatory text** to indicate what the user is doing on each screen.
...
* [10 Usability Heuristics for User Interface Design](https://www.nngroup.com/articles/ten-usability-heuristics/) \- Reading  
* [The Gestalt Principles](https://ixdf.org/literature/topics/gestalt-principles?srsltid=AfmBOoohbb3A-LP6xI2UDSYaCzI_Lp4OcKBWMrp0vpa2q9Vmj9_KIFQ1) \- Reading. Gestalt principles are rules of human perception that describe how our brains naturally group individual visual elements into whole, organized shapes rather than seeing them as separate parts.

**During Next Class**  
Your user flows and wireframes need to be completed in Figma for the next class. You will present them to your group for feedback. 

**Rubric**  
Assignment score: X / 9 points

- [ ] Shared Link to Figma page provided

      Figma / screenshots include userflows and wireframes that address:
