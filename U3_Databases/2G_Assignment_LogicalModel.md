# Group Assignment - Logical Model

In your group's database repository in the **main** branch...

As a GROUP, finalize a logical model.  Upload a digital copy of the logical model to the GROUP repository on the **MAIN** branch. 
